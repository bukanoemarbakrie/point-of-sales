                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('uploads/students/'. $student->image) }}" width="50"></td>
                            <td>{{ $student->name }}</td>
                            <td>{{ $student->email }}</td>
                            ...
                            <td>
                                ...
                                <form method="post" id="delete-form{{ $student->id }}" class="d-inline" action="{{ route('student.destroy', $student->id) }}">
                                    @csrf
                                    @method('DELETE')
