...
$selectProduct = mysqli_query($koneksi, "SELECT products.*, categories.category_name FROM products LEFT JOIN categories ON products.category_id = categories.id WHERE products.is_active = 1 ORDER BY id ASC");
            ...
            <div class="modal-body p-4">
                <div class="row">
                    ...
                    <div class="col-md-5 text-center mb-3 mb-md-0">
                        <img id="modalImage" src="assets/img/default.jpg" alt="Book Image" class="img-fluid rounded-4 shadow-sm"
                        ...
                        <div class="col-md-6">
                            <label class="w-100">
                                ...
                                <div class="card p-4 shadow-sm border payment-card h-100">
                                    ...
                                    <p class="text-muted mb-0">Bayar di tempat saat pesanan
                                        diterima.</p>
                                </div>
                            </label>
                        </div>
