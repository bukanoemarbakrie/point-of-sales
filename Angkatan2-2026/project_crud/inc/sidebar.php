...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <?php $rowMenus = mysqli_fetch_all($menus, MYSQLI_ASSOC); ?>
      ...
      <li class="menu-item">
        ...
        ?>
          <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <div data-i18n="Layouts"><?php echo $menu['name'] ?> </div>
          </a>
          ...
          <ul class="menu-sub">
            ...
            <?php foreach ($subMenus as $subMenu) : ?>
              <li class="menu-item">
                <a href="<?php echo $subMenu['url'] ?>" class="menu-link">
                  <div data-i18n="Without menu"><?php echo $subMenu['name'] ?></div>
                </a>
              </li>
            <?php endforeach ?>
          </ul>
