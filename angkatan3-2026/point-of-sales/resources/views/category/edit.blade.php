...
<div class="card border-light shadow-sm p-4">
    <h5 class="card-title mb-4">Edit Category: <span class="text-primary">{{ $edit->name }}</span></h5>
        ...
        <div class="mb-4">
            ...
            <div class="mt-2">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="is_active" id="active" value="1" {{ $edit->is_active == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="active">
                        <span class="badge bg-success">Active</span>
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="is_active" id="inactive" value="0" {{ $edit->is_active == 0 ? 'checked' : '' }}>
